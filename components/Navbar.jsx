  ...
  return (
    <header className="sticky top-0 z-40 bg-white/70 backdrop-blur-md border-b border-slate-200">
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
        <div className="text-lg md:text-xl font-semibold">Premium Portfolio</div>
        <nav className="hidden md:flex gap-6 items-center text-sm md:text-base font-medium">
          ...
          <button className="bg-brand-500 text-white px-4 py-2 rounded-md shadow">Hire me</button>
        </nav>
      ...
      {open && (
        <div className="md:hidden border-t border-slate-100 bg-white/95">
          <div className="px-4 py-4 flex flex-col gap-3">
            ...
            <button className="w-full bg-brand-500 text-white px-4 py-3 rounded-md">Hire me</button>
          </div>
        </div>
      )}
    </header>
